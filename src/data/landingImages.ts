...
export const landingImages: LandingImageMeta[] = [
  {
    ...
    alt: "Heavy Tow Pro flatbed truck transporting two Mercedes-Benz vehicles in the Bay Area",
    seoTitle: "Luxury Car Transport & Towing – Heavy Tow Pro Bay Area",
    seoDescription:
      "Heavy Tow Pro provides professional luxury and exotic car transport across the Bay Area. Our flatbed trucks ensure your Mercedes, BMW, or high-value vehicle is transported safely.",
  },
  {
    ...
    alt: "Heavy Tow Pro flatbed truck recovering a collision-damaged vehicle in San Francisco Bay Area",
    seoTitle: "Accident & Collision Vehicle Recovery – Heavy Tow Pro",
    seoDescription:
      "Involved in an accident? Heavy Tow Pro provides fast, professional accident vehicle recovery and towing throughout the San Francisco Bay Area. Available 24/7.",
  },
  {
    ...
    alt: "Heavy Tow Pro white Ram 5500 tow truck roadside assisting a white SUV on a Bay Area highway",
    seoTitle: "SUV & Truck Towing & Roadside Assistance – Heavy Tow Pro Bay Area",
    seoDescription:
      "Heavy Tow Pro offers fast roadside assistance and towing for SUVs, trucks, and vans throughout the Bay Area. Call us anytime — we'll get you moving.",
  },
  {
    id: "light_suv_mountain",
    src: "/work-images/light-duty/heavy-haulers-towing-suv-mountain-road-roadside-recovery-light-duty.webp",
    alt: "Heavy Tow Pro truck assisting a stranded SUV on a California mountain road",
    seoTitle: "Mountain & Rural Route Towing – Heavy Tow Pro Bay Area",
    seoDescription:
      "Broken down on a mountain road or rural highway? Heavy Tow Pro serves all Bay Area routes including hillside and rural roads. Fast response, any location.",
  },
  {
    id: "light_ram_truck",
    src: "/work-images/light-duty/heavy-haulers-towing-ram-5500-tow-truck-light-duty-roadside-service.webp",
    alt: "Heavy Tow Pro Ram 5500 light duty tow truck ready for roadside service",
    seoTitle: "Heavy Tow Pro Fleet – Professional Light Duty Tow Trucks Bay Area",
    seoDescription:
      "Heavy Tow Pro operates a modern fleet of light duty tow trucks for fast, reliable roadside service across the San Francisco Bay Area.",
  },
  {
    ...
    alt: "Heavy Tow Pro recovering a black car on a hillside road in San Francisco",
    seoTitle: "San Francisco Car Towing & Recovery – Heavy Tow Pro",
    seoDescription:
      "Heavy Tow Pro provides expert car recovery and towing across San Francisco's hills and neighborhoods. Fast dispatch, 24/7 availability.",
  },
  {
    ...
    alt: "Heavy Tow Pro recovering a black Cadillac Escalade SUV on a tree-lined residential road in the Bay Area",
    seoTitle: "Premium SUV Recovery & Towing Service – Heavy Tow Pro",
    seoDescription:
      "Heavy Tow Pro offers premium roadside recovery and towing for luxury SUVs and high-value vehicles. Trusted across Bay Area's residential and urban neighborhoods.",
  },
  {
    id: "light_rivian_ev",
    src: "/work-images/light-duty/heavy-haulers-towing-rivian-electric-suv-roadside-light-duty-bay-area.webp",
    alt: "Heavy Tow Pro light duty truck recovering a Rivian R1S electric SUV in the Bay Area",
    seoTitle: "Electric Vehicle (EV) Towing & Recovery – Heavy Tow Pro Bay Area",
    seoDescription:
      "Heavy Tow Pro has experience towing and recovering all types of electric vehicles including Rivian, Tesla, and other EVs throughout the San Francisco Bay Area.",
  },
  {
    ...
    alt: "Heavy Tow Pro flatbed truck transporting an AT&T utility service truck for commercial fleet towing",
    seoTitle: "Commercial Fleet & Utility Truck Towing – Heavy Tow Pro",
    seoDescription:
      "Heavy Tow Pro provides reliable commercial fleet towing and recovery for utility, telecom, and service vehicles across the Bay Area. Available 24/7 for fleet operators.",
  },
  {
    ...
    alt: "Heavy Tow Pro flatbed truck transporting a red industrial pump unit at a Bay Area industrial facility",
    seoTitle: "Industrial Equipment Transport & Towing – Heavy Tow Pro",
    seoDescription:
      "Heavy Tow Pro safely transports industrial pumps, generators, and heavy equipment for construction and industrial clients throughout the Bay Area.",
  },
  {
    ...
    alt: "Heavy Tow Pro heavy wrecker recovering a Recology garbage truck on a San Francisco street",
    seoTitle: "Municipal Fleet Towing San Francisco – Heavy Tow Pro",
    seoDescription:
      "Heavy Tow Pro is trusted by San Francisco municipal fleet operators including Recology for professional towing and recovery of refuse and service vehicles.",
  },
  {
    ...
    alt: "Heavy Tow Pro heavy wrecker parked alongside a Recology refuse truck at a Bay Area depot",
    seoTitle: "Commercial Refuse & Fleet Truck Towing – Heavy Tow Pro",
    seoDescription:
      "Heavy Tow Pro specialises in commercial refuse truck towing and fleet recovery for Bay Area municipal and waste management operators.",
  },
  {
    ...
    alt: "Close-up of Heavy Tow Pro heavy wrecker rigging a commercial municipal truck for recovery",
    seoTitle: "Commercial Truck Recovery & Towing Operations – Heavy Tow Pro",
    seoDescription:
      "See Heavy Tow Pro's professional commercial truck recovery in action. We safely rig and recover municipal and commercial vehicles across the Bay Area.",
  },
  {
    id: "medium_refuse_detail",
    src: "/work-images/medium-duty/heavy-haulers-towing-refuse-truck-flatbed-transport-medium-duty.webp",
    alt: "Heavy Tow Pro transporting a Recology refuse truck — rear detail view of medium duty towing operation",
    seoTitle: "Refuse & Garbage Truck Transport – Heavy Tow Pro Bay Area",
    seoDescription:
      "Heavy Tow Pro provides specialist refuse and garbage truck transport and recovery for Bay Area waste management fleets. Call for commercial service coordination.",
  },
  {
  ...
  },
  {
    ...
    alt: "Heavy Tow Pro heavy wrecker recovering a full semi truck and box trailer in the Bay Area",
    seoTitle: "Semi Truck & 18-Wheeler Recovery – Heavy Tow Pro Bay Area",
    seoDescription:
      "Heavy Tow Pro operates heavy duty wreckers capable of recovering and towing full semi trucks and 18-wheelers across the San Francisco Bay Area. 24/7 response.",
  },
  {
